...
public class FindPswActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        tv_user_name = (TextView) findViewById(R.id.et_user_name);
        ...
        btn_validate.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                ...
                if ("security".equals(from)) {
                    ...
                    if (TextUtils.isEmpty(userName)) {
                        ...
                        Toast.makeText(FindPswActivity.this, "您请输入的用户名不存在", Toast.LENGTH_SHORT).show();
                        ;
                        return;
                    ...
                    if (!TextUtils.isEmpty(sp_security)) {
